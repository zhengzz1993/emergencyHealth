    ...
    <div class="app"
      ...
      <div class="menu params"
        ...
        <el-tabs class="tabs"
                 ...
                 v-model="tabsActive">
          <el-tab-pane name="0">
              <div  slot="label"><i class="el-icon-setting"> 配置</i> </div>
          ...
          <el-tab-pane name="1"
              ...
              <div slot="label"><i class="el-icon-document-copy"> 数据</i></div>
            <el-form label-width="120px"
                     label-position="left"
                     size="mini">
          ...
          <el-tab-pane name="3"
            ...
            <div slot="label"><i class="iconfont icon-peizhi"> 事件</i></div>
            <el-form label-width="120px"
                     label-position="left"
                     size="mini">
          ...
          <el-tab-pane name="4"
                       v-if="isActive">
            <div slot="label"><i class="el-icon-folder"> 参数</i></div>
            <el-form label-width="120px"
                     label-position="left"
                     size="mini">
...
export default {
  ...
  methods: {
    ...
    handleRes () {
      if (this.isSql) {
        this.$set(this.activeObj, 'sql', JSON.stringify({
          db: this.db,
          sql: this.sql
        }))
      }
