...
// 全局路由
const globalRoutes = [
  {path: '/login', component: _import('modules/sys/login/login1'), name: 'login', meta: {title: '登录'}},
  {path: '/casLogin', component: _import('common/CasLogin'), name: 'casLogin', meta: { title: 'CAS登录' }}
  //{path: '/channelList/:deviceId/:parentChannelId/:count:/:page', component: _import('modules/sip/device/VmpDeviceChannelList'), name: 'channelList', meta: {title: '通道列表'}}
]
