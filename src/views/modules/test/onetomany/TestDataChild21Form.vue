        ...
        <el-col :span="12">
            <el-form-item label="出发地" prop="startArea.id"
              ...
              <SelectTree
                      ...
                      :clearable="true"
                      :accordion="true"
                      @getValue="(value, label) => {inputForm.startArea.id=value, inputForm.startArea.name=label}"/>
           </el-form-item>
        </el-col>
        <el-col :span="12">
            <el-form-item label="目的地" prop="endArea.id"
              ...
              <SelectTree
                      ...
                      :clearable="true"
                      :accordion="true"
                      @getValue="(value, label) => {inputForm.endArea.id=value, inputForm.endArea.name=label}"/>
           </el-form-item>
        </el-col>
        <el-col :span="12">
