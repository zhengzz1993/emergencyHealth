  ...
  <div class="page">
    ...
    <vxe-toolbar :refresh="{query: refreshList}" export print custom>
      <template #buttons>
        ...
        <el-button v-if="hasPermission('sys:menu:del')" :disabled="$refs.xTree && $refs.xTree.getCheckboxRecords().length === 0" type="danger" size="small" icon="el-icon-delete" @click="del()">删除</el-button>
      </template>
    </vxe-toolbar>
    <div style="height: calc(100% - 50px);">
      <vxe-table
        ...
        <vxe-table-column  title="图标" field="icon" align="center">
            <template slot-scope="scope">
              <i :class="scope.row.icon"></i>
            </template>
        </vxe-table-column>
        <vxe-table-column  title="类型" field="type" align="center">
              <template slot-scope="scope">
        ...
        <vxe-table-column title="排序号" field="sort" width="170px" align="center">
            <template slot-scope="scope">
        ...
        <vxe-table-column title="是否显示" field="isShow" align="center">
          <template slot-scope="scope">
                    <el-switch
        ...
        <vxe-table-column title="操作" width="150px" fixed="right" align="center">
          <template slot-scope="scope">
